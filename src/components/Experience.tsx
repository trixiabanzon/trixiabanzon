            ...
            {currentData.map((item: ExperienceItem) => (
              ...
              >
                ...
                <div className="z-10 sm:col-span-6">
                  {/* ROLE & COMPANY */}
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold leading-snug text-slate-200 transition-colors group-hover:text-[#c084fc]">
                      {item.role}
                    </h3>
                    <p className="mt-0.5 text-base font-medium text-slate-400">
                      {item.company}
                    </p>
                  </div>
                  ...
                  {/* SKILL TAGS (Safely handles undefined or empty skills array) */}
